...
@interface FFScrollViewImageView : UIView
...
@implementation FFScrollViewImageView{
    NSInteger strCount;
}
...
@interface FFScrollLabel()

@property (nonatomic, strong) NSTimer *timer;
@property (nonatomic, strong) FFScrollViewImageView *contentView;
@property (nonatomic, strong) UIImageView *scollImageView;
@property (nonatomic, assign) BOOL isScoll;

@end

@implementation FFScrollLabel
...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        self.scrollSpeed = 40;
        self.clipsToBounds = YES;
        self.contentView = [[FFScrollViewImageView alloc]initWithFrame:CGRectZero];
